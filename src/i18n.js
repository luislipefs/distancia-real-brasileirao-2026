...
const messages = {
  pt: {
    ...
    chartNote: 'Altura mostra os pontos: cada intervalo vale um ponto. Empates ficam na mesma altura; faixas suaves destacam grupos separados por até 4 pontos.',
    closeGroups: 'PELOTÕES PRÓXIMOS · ATÉ 4 PONTOS', closeGroupRange: '{clubs} clubes · {high}–{low} pts', profileBase: 'BASE NA PONTUAÇÃO DO ÚLTIMO COLOCADO · {points} PTS',
  ...
  en: {
    ...
    chartNote: 'Height shows points: each interval equals one point. Tied clubs share a height; soft bands highlight groups within four points.',
    closeGroups: 'CLOSE GROUPS · UP TO 4 POINTS', closeGroupRange: '{clubs} clubs · {high}–{low} pts', profileBase: 'BASE AT THE LAST-PLACED CLUB · {points} PTS',
  ...
  es: {
    ...
    chartNote: 'La altura muestra los puntos: cada intervalo equivale a un punto. Los empates quedan a la misma altura; las franjas suaves destacan grupos separados por hasta 4 puntos.',
    closeGroups: 'GRUPOS CERCANOS · HASTA 4 PUNTOS', closeGroupRange: '{clubs} clubes · {high}–{low} pts', profileBase: 'BASE EN LA PUNTUACIÓN DEL ÚLTIMO · {points} PTS',
  ...
  ja: {
    ...
    chartNote: '高さがポイントを示し、目盛り1つは1ポイントです。同ポイントのクラブは同じ高さに並び、4ポイント以内の集団を淡い帯で示します。',
    closeGroups: 'ポイントの近い集団 · 4ポイント以内', closeGroupRange: '{clubs}クラブ · {high}〜{low}ポイント', profileBase: '最下位クラブのポイントを基準 · {points}ポイント',
  ...
  fr: {
    ...
    chartNote: 'La hauteur représente les points : chaque intervalle vaut un point. Les clubs à égalité gardent la même hauteur ; des bandes légères signalent les groupes séparés de 4 points maximum.',
    closeGroups: 'GROUPES RAPPROCHÉS · 4 POINTS MAX.', closeGroupRange: '{clubs} clubs · {high}–{low} pts', profileBase: 'BASE AU SCORE DU DERNIER · {points} PTS',
